/**
 * В этом файле весь функционал по перводу плагина на русский язык
 * этот функционал используется в файле index.js
 */
...
const updateTranslations = {
  eventHeader() {
    ...
    eventHeader.innerHTML = new Date(eventHeader.innerHTML).toLocaleDateString(
      "ru-RU",
      {
        weekday: "short",
        month: "long",
